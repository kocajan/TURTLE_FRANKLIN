...
class Move:
    ...
    def append_last_dummy_pixel(self):
        ...
        if(abs(x-x_prev) == 1 and abs(y-y_prev) == 0):
            self.move_coords.append((self.move_coords[-1][0] + 1, self.move_coords[-1][1] + 1))
    ...
    def go_straight(self, length, dir):
        ...
        while not self.robot.is_shutting_down() and not self.robot.get_stop():
            ...
            print(self.robot.get_odometry()[0])
...
if __name__ == '__main__':
    ...
    path = [(250, 0), (251, 1), (252, 2), (253, 3), (254, 4), (255, 5), (256, 6), (257, 7), (258, 8), (259, 9), (260, 10), (261, 11), (262, 12), (263, 13), (264, 14), (265, 15), (266, 16), (267, 17), (268, 18), (269, 19), (270, 20), (271, 21), (272, 22), (273, 23), (274, 24), (275, 25), (276, 26), (277, 27), (278, 28), (279, 29), (280, 30), (281, 31), (282, 32), (283, 33), (284, 34), (285, 35), (286, 36), (287, 37), (288, 38), (289, 39), (290, 40), (291, 41), (292, 42), (293, 43), (294, 44), (295, 45), (296, 46), (297, 47), (298, 48), (299, 49), (300, 50), (301, 51), (302, 52), (303, 53), (304, 54), (305, 55), (306, 56), (307, 57), (308, 58), (309, 59), (310, 60), (311, 61), (312, 62), (313, 63), (314, 64), (315, 65), (316, 66), (317, 67), (318, 68), (319, 69), (320, 70), (321, 71), (322, 72), (322, 73), (322, 74), (322, 75), (322, 76)]
    path = [(250, 0), (251, 1), (252, 2), (253, 3), (254, 4), (255, 5), (256, 6), (257, 7), (258, 8), (259, 9), (260, 10), (261, 11), (262, 12), (263, 13), (264, 14), (265, 15), (266, 16), (267, 17), (268, 18), (269, 19), (270, 20), (271, 21), (272, 22), (273, 23), (274, 24), (275, 25), (276, 26), (277, 27), (278, 28), (279, 29), (280, 30), (281, 31), (282, 32), (283, 33), (284, 34), (285, 35), (286, 36), (287, 37), (288, 38), (289, 39), (290, 40), (291, 41), (292, 42), (293, 43), (294, 44), (295, 45), (296, 46), (297, 47), (298, 48), (299, 49), (300, 50), (301, 51), (302, 52), (303, 53), (304, 54), (305, 55), (306, 56), (307, 57), (308, 58), (309, 59), (310, 60), (311, 61), (312, 62), (313, 63), (314, 64), (315, 64), (316, 64), (317, 64), (318, 64), (319, 64), (320, 64), (321, 64), (322, 64), (323, 64), (324, 64), (325, 64), (326, 64), (327, 64), (328, 64), (329, 64), (330, 64), (331, 64), (332, 64), (333, 64), (334, 64), (335, 64), (336, 64), (337, 64), (338, 64), (339, 64), (340, 64), (341, 64)]
    #detection_cfg = yaml.safe_load(open('conf/detection.yaml', 'r'))
    
    #tmp = Move(None,  None, None)
    #tmp.move_sequence()
    #tmp.execute_move()


    # test for regulated move
    # Create robot object
