...
def capture_images() -> None:
    ...
    path = os.path.join(path, '../camera/shoot9')
...
def button_cb(event):
    ...
    if shoot:
        ...
        image_path = os.path.join('../camera/shoot9', f'RGB{counter}.png')
        point_cloud_path = os.path.join('../camera/shoot9', f'PC{counter}.npy')
