...
class Move:
    ...
    def check_trend(self, index, prev_index, rotation, translation, sequence):
        ...
        if index != prev_index and prev_index is not None:
            ...
            if index == 0:
                ...
                return SingleMove(rotation-sequence[-1].get_rotation(), translation)
    ...
    def move_sequence(self):
        ...
        sequence.append(SingleMove(0, 0))  # dummy move to prevent out of bounds in array
        #TODO vyzkousime floating kompenzaci zataceni, bude to jak takova banka
        ...
        sequence.append(self.check_trend(index, 10, rotation - last_compensation, translation, sequence)) # pridane minus pico
        return sequence
