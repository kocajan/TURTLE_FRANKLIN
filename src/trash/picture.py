...
def capture_images():
    ...
    path = os.path.join(path, 'camera/shoot8')
...
def button_cb(event):
    ...
    if shoot:
        ...
        image_path = os.path.join('camera/shoot8', f'RGB{counter}.png')
        point_cloud_path = os.path.join('camera/shoot8', f'PC{counter}.npy')
